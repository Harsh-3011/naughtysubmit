...
let isUsernameValid = () => {
  /* Username should be contain more than 5 characters. Should begin with alphabetic character  Can contain numbers */
  const usernameRegex = /^[a-zA-Z][a-zA-Z0-9]{5,32}/gi;
